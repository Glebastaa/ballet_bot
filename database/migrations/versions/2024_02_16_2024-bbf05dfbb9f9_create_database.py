...
Revision ID: bbf05dfbb9f9
Revises: 
Create Date: 2024-02-16 20:24:00.188806
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['individual_lesson_id'], ['individual_lessons.id'], name=op.f('fk_students_individual_lesson_id_individual_lessons')),
